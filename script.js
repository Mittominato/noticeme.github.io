...
document.querySelectorAll(".semuatugas")[e].style.backgroundColor = "#0396FF";
...
document.querySelectorAll(".semuatugas")[e].style.backgroundColor = "#D939CD";
...
document.querySelectorAll(".semuatugas")[e].style.backgroundColor = "#7367F0";
...
document.querySelector(".detailrencana").style.backgroundColor = "#0396FF";
...
document.querySelector(".detailrencana").style.backgroundColor = "#D939CD";
...
document.querySelector(".detailrencana").style.backgroundColor = "#7367F0";
} else {
    document.querySelector(".detailrencana").style.backgroundColor = "rgba(255,255,255,.2)";
}
};
